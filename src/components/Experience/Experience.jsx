...
const education = [
  {
    ...
    period: '2023 – 2026',
    description: 'Completed my BCA degree with a focus on computer science fundamentals, software engineering, and modern web technologies. Building real-world project experience alongside academic curriculum.',
    icon: <HiAcademicCap />,
